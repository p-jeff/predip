    ...
    always: [
      {
        ...
        sender: "DigitaVida",
        markdownText:
          "Dear Colleagues,\n\nI hope this email finds you well. I am writing to discuss a topic of vital importance to all of us – the prospect of collective action, and joining our union DigitaVia.\n\nWhy Unionize?\nUnionizing provides numerous benefits, including:\n\tStronger Collective Voice: Together, we can better advocate for our rights, fair wages, and improved working conditions.\n\tNegotiation Power: A union allows us to negotiate as a group with management, ensuring our concerns are heard and addressed.\n\tLegal Support and Protection: Unions offer legal resources to protect our employment rights.\n\nNext Steps\nI propose we hold an initial meeting to explore this idea further. This will be an opportunity to discuss our needs, address any concerns, and outline the process of union formation.\n\nMeeting Details:\nDate: Next Wednesday\nTime: 18:00 \n\nYour attendance and input are crucial. Even if you're unsure about unionizing, I encourage you to join the meeting to learn more and share your perspective.\n\nPlease respond to this email to confirm your attendance or suggest alternate dates and times.\n\nThank you for considering this significant step towards improving our workplace. Together, we can make a positive change.\n\n",
      },
      {
        id: 292,
        heading: "Reminder of Core Values and Policies",
        sender: "Emma Clark-Sunning",
        markdownText:
          "Dear Team,\n\nI hope this message finds you well. I wanted to take a moment to remind everyone about the core values and policies that define our company culture. As we continue to innovate and excel in our industry, it's crucial that we maintain our focus and commitment to our shared goals.\n\nI want to emphasize that our success has been built on our ability to work directly and agilely as a team. Our open-door policy ensures that concerns and suggestions can be addressed swiftly and effectively without the need for third-party intervention.\n\nPlease remember that our collective efforts have led to significant achievements, and maintaining a direct line of communication within our team is essential for our continued growth. Any action that might introduce external complexities or bureaucracy could potentially impact our project timelines and the dynamic environment we have all worked so hard to create.\n\nAs a reminder, it's important for all of us to adhere to the company's policies, which were designed to support our innovative and collaborative work environment. Let’s continue to focus on what we do best: working together to achieve remarkable things.\n\nIf there are any concerns or issues, I encourage you to bring them directly to your supervisors or to me. Our commitment to an open and constructive dialogue is key to our mutual success. To give you a view into what’s happening behind the scenes, I wanted to remind you all that the yearly report is coming up and there are discussions of profit distributions, directly rewarding everyone in accordance to their performance.\n\nThank you for your ongoing dedication and hard work.\n\nBest regards, Emma Clark-Sunning",
      },
      {
        id: 293,
        heading: "Article",
        sender: "Mom",
        markdownText:
          'Hey, i found this article. Doest your company work on this? \n\n ## PNF Telemarketing to install AI Systems ## \n\n In a groundbreaking move, PNF Telemarketing Inc. has announced the replacement of its customer assistant staff with state-of-the-art AI systems. This strategic decision marks a significant shift in the industry, as AI technology continues to reshape the landscape of customer service.\n\nThe new AI systems, equipped with cutting-edge natural language processing and machine learning capabilities, are designed to handle customer inquiries with unprecedented efficiency and accuracy. PNF Telemarketing Inc.\'s CEO, John Doe, stated, "The adoption of AI technology will not only streamline our operations but also enhance the customer experience with instant and precise responses."\n\nWhile this move promises increased operational efficiency, it raises concerns about the impact on employment. The company assures that staff affected by this change will receive comprehensive retraining programs to help them transition into new roles within the company.\n\nExperts believe that this trend will continue as AI technology becomes more sophisticated, urging companies to balance technological advancement with social responsibility.\n\nFor PNF Telemarketing Inc., the future of customer service lies in AI, setting a new standard for the industry.',
      },
    ],
    decision0: [{
      "id": 201,
